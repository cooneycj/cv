...
\setkomavar{fromname}{Cathal Cooney} % Your name
\setkomavar{fromaddress}{6 Sydenham Road\\Dundrum\\Dublin 14} % Your address
\setkomavar{fromphone}{(087) 698-1518} % Your phone number
\setkomavar{fromemail}{cathal.cooney@gmail.com} % Your email address
\setkomavar{place}{} % City written before the date, put your city here if you want this
\setkomavar{signature}{Cathal Cooney} % Your name as you want it to appear in the signature
...
\fontsize{21}{21}\selectfont\scshape Ph.D. Candidate, Trinity College Dublin } % Your current job title
...
I am interested in applying for the position of Python Developer that you have advertised on LinkedIn.\\  
...
I have just submitted my Ph.D. thesis to the School of Maths in Trinity College Dublin. I have gained much experience working with Python and Matlab while working on my thesis, which, combined with my background in Pure Mathematics, would make me very suitable for such a role. During the course of my studies I analysed neuronal spike trains using predominately self-written Python and C++ code, and I had to interact with others who used Matlab code.  I believe that my experience using these programming languages to analyse large data sets would be very beneficial to this role.\\   
...
I would very much like to interview in person.  I would be available to interview at any point during the work week, as I am not teaching classes this semester.  I can take phone calls at any point on 087-698 1518. Thank you very much for taking your time to consider my application.\\
